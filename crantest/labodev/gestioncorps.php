...
$codification='';
//CORPS
$query_rs_corps = "SELECT corps.*, cat.codelibcat FROM corps,cat WHERE corps.codecat=cat.codecat and codecorps<>'' order by numordre";
$rs_corps = mysql_query($query_rs_corps) or die(mysql_error());
$row_rs_corps = mysql_fetch_assoc($rs_corps);
$totalRows_rs_corps = mysql_num_rows($rs_corps);
$form_corps = "form_cat";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_corps ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Corps</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
                <tr>
            ...
            <tr class="head">
                ...
                <td class="bleugrascalibri10">Code lib cat</td>
                <td class="bleugrascalibri10">Lib. corps fr</td>
                <td class="bleugrascalibri10">Lib. corps en</td>
            </tr>
            <?php 
            $class="even";
            do
            ...
            <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                <td align="center" class="noircalibri10"><?php echo $row_rs_corps['codecorps']; ?></td>
                <td align="center" class="noircalibri10"><?php echo $row_rs_corps['codelibcat']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_corps['liblongcorps_fr']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_corps['liblongcorps_en']; ?></td>
            </tr>
            <?php 
            } while ($row_rs_corps = mysql_fetch_assoc($rs_corps)); ?>
            </table>
            </form>
        </td>
    </tr>
