...
$codification='';
//CONTRAT STATUT PARTENAIRE
$query_rs_cont_statutpart=" SELECT codestatutpart, libcourtstatutpart as libstatutpart".
										" FROM cont_statutpart ORDER BY libstatutpart asc";
$rs_cont_statutpart = mysql_query($query_rs_cont_statutpart) or die(mysql_error());


$form_cont_statutpart = "form_cont_statutpart";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_cont_statutpart ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="MM_update" value="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="codestatutpart" value="codestatutpar">
            <input type="image" src="images/espaceur.gif" width="0" height="0">  
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Contrat statut partenaire</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
                <tr>
            ...
            <tr class="head">
                ...
                <td class="bleugrascalibri10">Statut partenaire</td>
            </tr>
            <?php 
            $class="even";
            while ($row_rs = mysql_fetch_assoc($rs_cont_statutpart))
            { ?>
                <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                  <td align="center" class="noircalibri10"><?php echo $row_rs['codestatutpart']; ?></td>
                  <td class="noircalibri10"><?php echo $row_rs['libstatutpart']; ?></td>
                </tr>
            <?php 
            } ; ?>
            </table>
