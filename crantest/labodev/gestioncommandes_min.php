...
$peut_etre_admin=estrole('sif',$tab_roleuser) || estrole('du',$tab_roleuser) || estrole('admingestfin',$tab_roleuser);

if(!isset($_SESSION['b_cmd_version_mini'])) { $_SESSION['b_cmd_version_mini']=false;}
...
// commandes dont le codeuser est respcontrat
...
<script src="_java_script/jquery-3.2.1.min.js" type="text/javascript" language="javascript"></script>
...
{  ?>o=new Object();o["codecentrecout"]="<?php echo js_tab_val($row_rs_contrat['codecentrecout']); ?>";o["codecontrat"]="<?php echo js_tab_val($row_rs_contrat['codecontrat']); ?>";o["libcontrat"]="<?php echo js_tab_val($row_rs_contrat['libcontrat']);?>";o["solde"]="<?php echo js_tab_val($row_rs_contrat['solde']);?>";tab_contrat[<?php echo $nb ?>]=o;
<?php
	$nb++;
}?>
...
{  ?>o=new Object();o["codecentrecout"]="<?php echo js_tab_val($row_rs_eotp['codecentrecout']); ?>";o["codeeotp"]="<?php echo js_tab_val($row_rs_eotp['codeeotp']); ?>";o["libeotp"]="<?php echo js_tab_val($row_rs_eotp['libeotp']);?>";o["solde"]="<?php echo js_tab_val($tab_eotp[$codeeotp]['solde']);?>";tab_eotp[<?php echo $nb ?>]=o;
<?php 
	$nb++;
}?>
nbeotp=<?php echo $nb; ?>;
...
{ even_ou_odd='even';
	...
	// 20170416 inversion de lignes pour test
	/* $('#'+tablerow.id).replaceWith($('#tc3').after($('#'+tablerow.id).clone(true)));
	window.location.hash='#'+tablerow.id */
	// 20170416 fin inversion de lignes pour test
              ...
              <tr>
              	<td>
                	<table>
                      ...
                      <td><a href="aide12plusbudget.html" target="blank">Aide m&eacute;moire 12+ budget/commandes</a></td>
                    </tr>
                  </table><!-- table10-->
                </td>
              </tr>
            ...
            <?php 
					...
					{ $numrow++;
						...
						*/
						...
						if($droitmodif!="write")
						{ if((array_key_exists('secrsite',$tab_rolecmduser) || droit_acces($tab_contexte))
							&& $cmd_ou_miss=='commande' && $row_rs_commande['estinventorie']!='oui'  && $tab_contenu_col_role_droit['sif#1']['colonne']=='visa appose'
          	...
          	$ligne.='<td><a name="'.$codecmdmiss.'"></a>';
						...
						$ligne.=($mini?'':'<td>');
						//duplication possible pour tous sauf le referent s'il n'est que référent
