...
$codification='';
//THEMES
$query_rs_statutvisa = "SELECT * FROM statutvisa";
$rs_statutvisa = mysql_query($query_rs_statutvisa) or die(mysql_error());
$row_rs_statutvisa = mysql_fetch_assoc($rs_statutvisa);
$totalRows_rs_statutvisa = mysql_num_rows($rs_statutvisa);
$form_statutvisa = "form_statutvisa";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_statutvisa ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="MM_update" value="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="codecorps" value="codecorps">
            <input type="image" src="images/espaceur.gif" width="0" height="0">  
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td align="center"><span class="mauvegrascalibri11">Visas - R&ocirc;les</span></td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr <tr class="head">
                <td class="bleugrascalibri10">Code Statut  visa</td>
                <td class="bleugrascalibri10">Code role</td>
                <td class="bleugrascalibri10">Lib. statutvisa</td>
            </tr>
            <?php 
            $class="even";
            do
            ...
            <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                <td align="center" class="noircalibri10"><?php echo $row_rs_statutvisa['codestatutvisa']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_statutvisa['coderole']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_statutvisa['liblong']; ?></td>
            </tr>
            <?php 
