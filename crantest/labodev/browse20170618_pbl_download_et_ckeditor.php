					...
					<tr>
						<td>
										...
										<table cellpadding="4">
											<tr>
												...
												{ $un_code_rep_ou_fichier=$une_ligne['code_rep_ou_fichier'];
													echo ($first?"":" > ");
													$first=false;?>
													<span class="bleucalibri10"><a href="browse.php?coderep_courant=<?php echo $un_code_rep_ou_fichier ?>"/><?php echo $tab_repfichier_trie[$tab_ascendants[$num]]['nom'] ?></a></span>
												<?php 
												}?>
												</td>
											</tr>
                          ...
                          { $un_code_rep_ou_fichier=$une_ligne['code_rep_ou_fichier'];
                            ...
                            <img src="images/espaceur.gif" width="<?php echo 14*$une_ligne['profondeur'] ?>" height="1" /><img src="<?php echo $rep_icone ?>/<?php echo $icone ?>.png" width="20" height="20" align="absbottom"/>&nbsp;<?php if ($une_ligne['type_rep_ou_fichier']=='R') {?><a href="browse.php?coderep_courant=<?php echo $un_code_rep_ou_fichier ?>"/><?php }?><?php echo $une_ligne['nom']?><?php if ($une_ligne['type_rep_ou_fichier']=='R') {?></a><?php }?><br>
                          <?php 
                          }
													...
													{ $affiche=false;
														...
														{ if($type_rep_ou_fichier=='R')
															{ $affiche=true;
																...
																$cellule_rep_ou_fichier.=' ondblclick="document.location.href=\'browse.php?coderep_courant='.$un_code_rep_ou_fichier.'\'"/>';
															}
															else
