...
$codification='';
//CONTRAT TYPE CONVENTION
$query_rs_cont_typeconvention=" SELECT codetypeconvention, libcourttypeconvention as libtypeconvention".
										" FROM cont_typeconvention ORDER BY libtypeconvention asc";
$rs_cont_typeconvention = mysql_query($query_rs_cont_typeconvention) or die(mysql_error());

$form_cont_typeconvention = "form_cont_typeconvention";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_cont_typeconvention ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="MM_update" value="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="codetypeconvention" value="codetypeconvention">
            <input type="image" src="images/espaceur.gif" width="0" height="0">  
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Contrat type convention</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
                <tr>
            ...
            <tr class="head">
                ...
                <td class="bleugrascalibri10">Type convention</td>
            </tr>
            <?php 
            $class="even";
            while ($row_rs = mysql_fetch_assoc($rs_cont_typeconvention))
            { ?>
                <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                  <td align="center" class="noircalibri10"><?php echo $row_rs['codetypeconvention']; ?></td>
                  <td class="noircalibri10"><?php echo $row_rs['libtypeconvention']; ?></td>
                </tr>
                <?php 
            } ; ?>
            </table>
