...
$codification='';
//CORPS
$query_rs_corpsmodefinancement = "SELECT corps.*,corpsmodefinancement.codemodefinancement,liblongmodefinancement".
																" FROM corps,corpsmodefinancement left join modefinancement on corpsmodefinancement.codemodefinancement=modefinancement.codemodefinancement".
																" WHERE corps.codecorps=corpsmodefinancement.codecorps and corps.codecorps<>''".
																" order by corps.codecorps,numordre";
...
$totalRows_rs_corpsmodefinancement = mysql_num_rows($rs_corpsmodefinancement);

$form_corpsmodefinancement = "form_corpsmodefinancement";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_corpsmodefinancement ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="MM_update" value="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="codecorpsmodefinancement" value="codecorpsmodefinancement">
            <input type="image" src="images/espaceur.gif" width="0" height="0">  
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Corps - Modes de financement</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
                <tr>
            ...
            <tr class="head">
                ...
                <td class="bleugrascalibri10">Code mode de financement</td>
                <td class="bleugrascalibri10">Lib. corps</td>
                <td class="bleugrascalibri10">Lib. mode de financement</td>
            </tr>
            <?php 
            $class="even";
            do
            ...
            <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                <td align="center" class="noircalibri10"><?php echo $row_rs_corpsmodefinancement['codecorps']; ?></td>
                <td align="center" class="noircalibri10"><?php echo $row_rs_corpsmodefinancement['codemodefinancement']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_corpsmodefinancement['liblongcorps_fr']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_corpsmodefinancement['liblongmodefinancement']; ?></td>
            </tr>
            <?php 
