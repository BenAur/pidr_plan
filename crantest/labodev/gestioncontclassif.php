...
$query_rs_cont_classif=" SELECT codeclassif, numclassif,libcourtclassif as libclassif".
										" FROM cont_classif ORDER BY numclassif asc";
$rs_cont_classif = mysql_query($query_rs_cont_classif) or die(mysql_error());;

$form_cont_classif = "form_cont_classif";
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_cont_classif ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="MM_update" value="<?php echo $_SERVER['PHP_SELF'] ?>">
            <input type="hidden" name="codeclassif" value="codeclassif">
            <input type="image" src="images/espaceur.gif" width="0" height="0">  
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Contrat classification</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
                <tr>
            ...
            <tr class="head">
                ...
                <td class="bleugrascalibri10">Num classif</td>
                <td class="bleugrascalibri10">Classification</td>
            </tr>
            <?php 
            $class="even";
            while ($row_rs = mysql_fetch_assoc($rs_cont_classif))
            { ?>
                <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                <td align="center" class="noircalibri10"><?php echo $row_rs['codeclassif']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs['numclassif']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs['libclassif']; ?></td>
                </tr>
                <?php 
            } ; ?>
            </table>
