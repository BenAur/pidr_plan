...
$codification='';
//THEMES
$query_rs_cat = "SELECT * FROM cat order by codecat";
$rs_cat = mysql_query($query_rs_cat) or die(mysql_error());
...
<table border="0" align="center" cellpadding="0" cellspacing="1">    
    ...
    <tr>
        <td>
            <form name="<?php echo $form_cat ?>" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <tr class="head">
                <td align="center" class="mauvegrascalibri11">Cat&eacute;gories</td>
            </tr>
            </table>
            <table border="0" align="center" cellpadding="3" cellspacing="1">
            <tr class="head">
                <td class="bleugrascalibri10">Code cat</td>
                <td class="bleugrascalibri10">Code lib cat</td>
                <td class="bleugrascalibri10">Lib. cat fr</td>
                <td class="bleugrascalibri10">Lib. cat en</td>
            </tr>
            <?php 
            $class="even";
            do
            ...
            <tr class="<?php ($class=="even"?$class="odd":$class="even"); echo $class; ?>">
                <td align="center" class="noircalibri10"><?php echo $row_rs_cat['codecat']; ?></td>
                <td align="center" class="noircalibri10"><?php echo $row_rs_cat['codelibcat']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_cat['libcat_fr']; ?></td>
                <td class="noircalibri10"><?php echo $row_rs_cat['libcat_en']; ?></td>
            </tr>
            <?php 
            } while ($row_rs_cat = mysql_fetch_assoc($rs_cat)); ?>
            </table>
            </form>
        </td>
    </tr>
