...
{ if(estblock('b_annule_organisme'))
	...
	{	t=tab_theme[numtheme]
		...
		{ ?>txt="D�partement : ";
				href='<?php echo $GLOBALS['racine_site'] ?>'+'francais/themes_rech/'+t['libcourttheme'].toLowerCase()+'/index.php'
		<?php 
		}
		else
		{ ?>txt="Department: ";
				href='<?php echo $GLOBALS['racine_site'] ?>'+'anglais/themes_rech/'+t['libcourttheme'].toLowerCase()+'/index.php'
		<?php 
		}?>
